...
#
# Chained pipeline:
#   1. placement_wm embed (3_place.odb -> 3_place_order_wm.odb)
...
#   3. cts_wm embed (4_cts.odb -> 4_cts_wm.odb)
#   4. make wm_route_wrong_way with CTS_ODB=4_cts_wm.odb and
#      PRE_GLOBAL_ROUTE_TCL=routing_wm/pre_route_watermark.tcl, which
